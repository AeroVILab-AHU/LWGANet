...
from geoseg.models.UNetFormer_lwganet import UNetFormer_LWGANet_L2
...
weights_name = "unetformer-lwganet_l2-1024-768crop-e70"
...
#  define the network
net = UNetFormer_LWGANet_L2(num_classes=num_classes, dropout=0.1)
# flops and params
...
train_dataset = UAVIDDataset(data_root='/dataset/seg/uavid/train_val',
                             img_dir='images', mask_dir='masks',
                             mode='train', mosaic_ratio=0.25,
                             transform=train_aug, img_size=(1024, 1024))

val_dataset = UAVIDDataset(data_root='/dataset/seg/uavid/val',
