...
weights_name = "unetformer-lwganet_l2-512crop-ms-epoch30-rep"
...
#  define the network
net = UNetFormer_LWGANet_L2(num_classes=num_classes)
...
train_dataset = LoveDATrainDataset(transform=train_aug, data_root='/dataset/seg/LoveDA/trainval')
